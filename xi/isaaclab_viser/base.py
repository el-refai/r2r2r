...
from xi.utils.urdf_loader import load_urdf
...
from xi.isaaclab_viser.data.batch_data_logger import BatchDataLogger

import os 
from collections import deque
from copy import deepcopy
from abc import ABC, abstractmethod
from xi.isaaclab_viser.camera_manager import CameraManager
...
assets_root_path = '/home/lifelong/Materials/vMaterials_2'
textures = [
    assets_root_path + "/Metal/textures/polish_wipe.jpg",
    assets_root_path + "/Metal/textures/brushed_antique_copper_patina_diff.jpg",
    assets_root_path + "/Carpet/textures/rug_carpet_multi_fibers.jpg",
    assets_root_path + "/Plastic/textures/pcb_solder_mask_SSS.jpg",
    assets_root_path + "/Composite/textures/fiber_bump.jpg",
    assets_root_path + "/Paint/Carpaint/textures/smudges_scratches_A_rough.jpg",
    assets_root_path + "/Plastic/textures/pcb_solder_mask_rough.jpg",
    assets_root_path + "/Plastic/textures/pcb_solder_mask_SSS.jpg",
]
...
mdls = [
    ...
    assets_root_path + "/Fabric/Felt_Plain.mdl",
]
...
class IsaacLabViser:
    ...
    def __init__(self,
        ...
        render_cfg = sim_utils.RenderCfg(antialiasing_mode='DLAA', enable_dl_denoiser=True, dlss_mode=2)
    ...
    def randomize_viewaug(self):
        ...
        if hasattr(self.camera_manager, 'frustums'):
            ...
            for frustum in self.camera_manager.frustums:
                frustum.position = self.original_frustums[frustum.name][:3] + np.random.rand(*frustum.position.shape) * 0.01
                frustum.wxyz = self.original_frustums[frustum.name][3:] + np.random.rand(*frustum.wxyz.shape) * 0.015
    ...
    def randomize_skybox(self):
        skybox_dir = "/home/lifelong/xi/data/assets/skyboxes" # TODO: update this path
